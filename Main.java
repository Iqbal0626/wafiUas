...
public class Main {
    ...
    public void selectJuice() {
        if (this.water.getAmount() == 1) {
            ...
            System.out.println("Selamat, Anda mendapat diskon 1% untuk pembelian jus ini");
        } else {
    ...
    public void selectCoffee() {
        if (this.juice.getAmount() == 3) {
            ...
            System.out.println("Selamat, Anda mendapat diskon 3% untuk pembelian kopi ini");
        } else if (this.water.getAmount() == 1) {
            this.totalPrice = this.totalPrice + coffee.getAmount() * (coffee.getPrice() * (100 - 0.3) / 100);
            System.out.println("Selamat, Anda mendapat diskon 0.3% untuk pembelian kopi ini");
        } else {
    ...
    public void selectWater() {
        if (coffee.getAmount() == 3 && soda.getAmount() == 3) {
            ...
            System.out.println("Selamat, Anda mendapat diskon 9% untuk pembelian air putih ini");
        } else {
    ...
    public void selectSoda() {
        if (this.water.getAmount() == 1) {
            ...
            System.out.println("Selamat, Anda mendapat diskon 0.3% untuk pembelian soda ini");
        } else {
    ...
    public static void main(String[] args) {
        ...
        for (String i = "Y"; i.equals("Y") || i.equals("y");) {
            ...
            System.out.println("Apakah anda mau melanjutkan? Y/N");
            i = scan.next();
        }
